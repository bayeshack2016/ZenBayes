...
bls <- readRDS("/Users/rbrady/bayes_hack/data/processed/bls_project_gain_loss_sorted_titles.rds")
biggest.loss <- subset(bls, employment.2014 - employment.2024 > 10000)
titles<-lapply(biggest.loss$SOC.Code, get.titles, 
               onet.data = get.onet.data.table("/Users/rbrady/bayes_hack/data/O_NET/Occupation Data.txt"));
